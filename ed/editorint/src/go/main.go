...
func (e *Editor) KeyBackspace() {
	...
	if e.line != e.lines.Front() {
		prev := e.line.Prev()
		e.cursor = prev.Value.End()
		for it := e.line.Value.Front(); it != e.line.Value.End(); it = e.line.Value.Front() {
			prev.Value.Insert(prev.Value.End(), it.Value)
...
func (e *Editor) KeyDelete() {
	...
	if e.line.Next() != e.lines.End() {
		next := e.line.Next()
		for it := next.Value.Front(); it != next.Value.End(); it = next.Value.Front() {
